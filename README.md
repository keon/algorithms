...
- [array](array)
    ...
    - [max_ones_index](array/max_ones_index.py)
    ...
    - [test_array](array/test_array.py)
...
- [bit](bit)
    ...
    - [flip_bit_longest_seq.py](bit/flip_bit_longest_seq.py)
...
- [graph](graph)
    ...
    - [test_graph](graph/test_graph.py)
...
- [maths](maths)
    ...
    - [test_maths](maths/test_maths.py)
- [matrix](matrix)
...
- [search](search)
    ...
    - [test_search](search/test_search.py)
- [set](set)
