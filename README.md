...
- [pattern matching](algorithms/pattern_matching)
    - [bmh](algorithms/pattern_matching/bmh.py)
    - [bmhs](algorithms/pattern_matching/bmhs.py)
    - [shift-and](algorithms/pattern_matching/shift1_and.py)
