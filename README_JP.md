...
- [math : 数学](algorithms/math)
    ...
    - [gcd/lcm](algorithms/math/gcd.py)
...
- [string : 文字列](algorithms/string)
    - [fizzbuzz](algorithms/string/fizzbuzz.py)
    - [delete_reoccurring_characters](algorithms/string/delete_reoccurring_characters.py)
