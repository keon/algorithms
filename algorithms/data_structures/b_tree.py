...
class BTree:
    ...
    def _merge(self, parent_node: Node, to_merge_index: int, transferred_child_index: int) -> None:
    ...
    def _remove_from_nonleaf_node(self, node: Node, key_index: int) -> None:
        """Remove a key from a non-leaf node by replacing it with a predecessor or successor.
