...
if __name__ == "__main__":
    ...
    print("Sum of elements in arr[0..5] is " + str(get_sum(bit_tree,5)))
    
    freq[3] += 6
    update_bit(bit_tree, len(freq), 3, 6) 
    print("Sum of elements in arr[0..5]"+
                        " after update is " + str(get_sum(bit_tree,5)))
