"""
At a job interview, you are challenged to write an algorithm to check if a given stringing, s, can be formed from two other stringings, part1 and part2.
The restringiction is that the characters in part1 and part2 are in the same order as in s.
